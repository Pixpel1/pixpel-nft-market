...
export const TransferOverviewLine: FC<TransferOverviewLineProps> = ({
    ...
    <StyledProcessWrapper strikeThrough={completed}>
        <Image
            ...
            width="20"
        />
        <Text fontFamily="Roboto" fontSize="11" fontWeight="light" fontColor="White" fontLetterSpacing="0">
            {title}
        </Text>
        <Text fontFamily="Roboto" fontSize="11" fontWeight="bold" fontColor="#0095c8" fontLetterSpacing="0">
            {details}
        </Text>
...
export const TransferOverview: FC<PropsWithChildren<Props>> = ({
    ...
    return (
        <PageWrapper>
            <StyledContainer>
                <div>
                    <Text fontFamily="Roboto" fontSize="24" fontWeight="bold" fontColor="White" fontLetterSpacing="0">
                        {timeToComplete}
                    </Text>
                    <div style={{ marginTop: 64 }} />
                    <Text fontFamily="Roboto" fontSize="20" fontWeight="bold" fontColor="White" fontLetterSpacing="0">
                ...
                <Text fontSize="20" fontWeight="light" fontColor={status?.isError ? "Red" : "DarkGrey"} align="center">
                    {status ? status.message : <>&nbsp;</>}
                </Text>
                <ButtonsContainer>
                    <Button bg="#37404C" variant="rest" onClick={cancel}>
