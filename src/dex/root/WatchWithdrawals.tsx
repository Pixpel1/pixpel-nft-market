...
import { useEthMerkleProof, usePendingWithdrawals } from "@dex/api-query/queries";
...
const WatchWithdrawals: FC = () => {
    ...
    return (
        <>
            ...
            {pendingWithdrawals
                .filter(
                    (tx) => tx?.origin_tx_hash !== undefined && approvedWithdrawals[tx.origin_tx_hash] === undefined
                )
                .map((tx) => (
                    <WatchWithdrawal
