    ...
    return (
        <div>
            ...
            <div className="flex py-6 overflow-x-auto relative w-full">
                ...
                <div className="flex text-base text-gray-400 w-1/6 px-6">NFT quantity</div>
                <div className="flex text-base text-gray-400 w-1/4 px-6">Total purchase valuet</div>
                <div className="flex text-base text-gray-400 w-1/6 px-6">Start Date</div>
                <div className="flex text-base text-gray-400 w-1/6 px-6">Earning</div>
                <div className="flex text-base text-gray-400 w-1/12 px-6">Expenses</div>
