            ...
            <div className="overflow-x-auto relative mt-10 x-full">
                <table className="table-auto">
                    <thead>
                        <tr>
                            <td>
                                <div className="text-gray-400 w-max">Game</div>
                            </td>
                            <td className="px-6">
                                <div className="text-gray-400 w-max">Coin</div>
                            </td>
                            <td className="px-6">
                                <div className="text-gray-400 w-max">Rewards</div>
                            </td>
                            <td className="px-6">
                                <div className="text-gray-400 w-max">Staked Amount</div>
                            </td>
                            <td className="px-6">
                                <div className="text-gray-400 w-max">Start Date</div>
                            </td>
                            <td className="px-6">
                                <div className="text-gray-400 w-max">EST.APY</div>
                            </td>
                            <td className="px-6">
                                <div className="text-gray-400 w-max">Locked Days</div>
                            </td>
                            <td className="px-6">
