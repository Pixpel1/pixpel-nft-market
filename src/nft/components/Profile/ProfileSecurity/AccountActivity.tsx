        ...
        <>
            <div className="flex flex-col bg-app-black rounded-lg px-6 py-8 gap-x-6 overflow-x-auto">
                ...
                <div className="flex justify-between mt-[30px] items-end flex-col 2xs:flex-row">
                    ...
                    <div className="ml-8 ">
                        <div
                            className="bg-app-blue hover:bg-[#50D0FB] rounded-md px-4 py-2 cursor-pointer flex justify-center items-baseline"
                            onClick={() => {
                ...
                <div className="flex justify-between my-8">
                    ...
                    <div
                        className="bg-app-blue hover:bg-[#50D0FB] rounded-md px-4 py-2 cursor-pointer flex justify-center items-center"
                        onClick={() => {
