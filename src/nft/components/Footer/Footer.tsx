        ...
        <div className="flex flex-col bg-app-black 2xl:px-20 xl:px-16 lg:px-12 md:px-9 sm:px-6 px-3 xl:pt-16 lg:pt-12 md:pt-9 sm:pt-6 pt-3 xl:pb-8 lg:pb-6 md:pb-4 pb-3">
            ...
            <div className="grid xl1:grid-cols-6 md1:grid-cols-3 2xs:grid-cols-2 grid-cols-1 2xl:mb-20 xl:mb-16 lg:mb-12 md:mb-9 sm:mb-6 mb-3 gap-10">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="text-2xl font-semibold xl:mb-6 md:mb-4 text-app-blue">Investors Portal</div>
                </div>
                <div className="flex flex-col">
                    <div className="text-2xl font-semibold xl:mb-6 md:mb-4 mb-2">Community</div>
                    <div className="flex flex-col gap-6">
                        <div className="flex gap-9">
                            <Image src={Facebook} alt="facebook" className="w-7 rounded-full" />
                            <Image src={Twitter} alt="twitter" className="w-7 rounded-full" />
                            <Image src={Telegram} alt="telegram" className="w-7 rounded-full" />
                        </div>
                        <div className="flex gap-9">
                            <Image src={Discord} alt="discord" className="w-7 rounded-full" />
                            <Image src={Linkedin} alt="linkedin" className="w-7 rounded-full" />
                        </div>
                    </div>
                </div>
            </div>
